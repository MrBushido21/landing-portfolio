...
//================================================================================================================================================
//-----------------ACARDEON---------------\
const items = document.querySelectorAll('.projects__acardeon-item');

items.forEach(item => {
    const name = item.querySelector('.projects__acardeon-name');
...
const swiperFirst = new Swiper('.swiper', {
  ...
  spaceBetween: 23, // отступы между слайдами
  ...
  slidesPerView: 2, // количесвто слайдов 
